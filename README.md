...
This repository serves as a **technical documentation and architectural overview** of the ProBarber SaaS platform. The project was built from the ground up (**Green Field**) to solve complex management challenges in the grooming industry.
